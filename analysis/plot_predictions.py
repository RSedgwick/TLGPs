...
from utils.plotting_utils import plot_all_models_from_hyperparameters, plot_lvmogp_latent_variables, plot_data
              ...
              for seed in [1, 2, 3]:
                     for dataseed in range(6):
                            ...
                            if os.path.exists(path):
                                   ...
                                   # plot_data(hyperparams, plot_data_points=True, save=True, save_path=plot_path,
                                   #           file_name=f'data_generating_functions_{surface_type}_{test_type}_points_seed_{seed}_dataseed_{dataseed}')
                                   # plot_data(hyperparams, plot_data_points=False, save=True, save_path=plot_path,
                                   #           file_name=f'data_generating_functions_{surface_type}_{test_type}_points_seed_{seed}_dataseed_{dataseed}')
